...
import { Sphere } from "..";
import { EntityType, Particle, Rigidbody } from "../entity";
import { RaycastHit, WorldQuery } from "./query";

export const QuerySphere: WorldQuery<Sphere> = {
    raycast: function (self: Sphere, selfEntity: Rigidbody | Particle, origin: Readonly<Vector3>, dir: Readonly<Vector3>): RaycastHit | null
    {
