...
export declare namespace vec3 {
    ...
    var plus: {
        (args_0: Readonly<Vector3>, args_1: Readonly<number | Vector3 | Vector2 | Vector4>): Vector3;
        (out: Vector3, args_0: Readonly<Vector3>, args_1: Readonly<number | Vector3 | Vector2 | Vector4>): Vector3;
    };
    var minus: {
        (args_0: Readonly<Vector3>, args_1: Readonly<number | Vector3 | Vector2 | Vector4>): Vector3;
        (out: Vector3, args_0: Readonly<Vector3>, args_1: Readonly<number | Vector3 | Vector2 | Vector4>): Vector3;
