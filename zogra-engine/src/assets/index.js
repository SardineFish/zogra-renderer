...
\r
    ...
    // fragColor = vec4(1);\r
}`;var f={default2D:[o,r],particle2D:[t,r],shadow2D:[a,e],light2D:[i,n],light2DSimple:[u,c],boxBlur:[o,l],bloomFilter:[o,s],bloomCompose:[o,m],blitCopy:[o,v]};export{f as ShaderSource};
